...
/**
 * Universal map-like string key-value store interface for abstracting Miracl client data storage.
...
public interface MiraclStatePreserver
{
	...
	/**
	 * Put value in preserver. If key already exist in preserver, overwrite it's value.
	 * @param key Key
	 * @param value Value
	 */
